...
-------------------------------------------------------
 ...
 - [ ] 02-    Inform with the Paragraph Element
 - [ ] 03-    Fill in the Blank with Placeholder Text
 - [ ] 04-    Uncomment HTML
 - [ ] 05-    Comment out HTML
 - [ ] 06-    Delete HTML Element
 - [ ] 07-    Introduction to HTML5 Elements
 - [ ] 08-    Add Images to Your Website
 - [ ] 09-    Link to External Pages with Anchor Elements
...
- [ ] 44- 	Use a media query to change a 
## CSS Flexbox
...
- [ ] 52- 	Make Motion More Natural Using a Bez
...
- [ ] 1- 	Build a Tribute PageNot Passed
- [ ] 2- 	Build a Survey FormNot Passed
- [ ] 3- 	Build a Product Landing PageNot Passed
- [ ] 4- 	Build a Technical Documentation PageNot Passed
- [ ] 5- 	Build a Personal Portfolio WebpageNot Passed
